...
export const useJSElements = (
  ...
  // -----------------------------
  const safeBind = (attr, eventName) => {
    htmlElement.querySelectorAll(`[${attr}]`).forEach((el) => {
  ...
  htmlElement.querySelectorAll("[data-key]").forEach((el) => {
  ...
  htmlElement.querySelectorAll("[data-hover]").forEach((el) => {
  ...
  htmlElement.querySelectorAll("[data-classlist]").forEach((el) => {
